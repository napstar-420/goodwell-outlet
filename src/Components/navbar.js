...
const Navbar = () => {
  ...
  return (
    <nav>
        ...
        <ul id='nav_bottom' className={`bg-[#303030] py-2 px-4 flex lg:flex-row flex-col lg:items-center lg:justify-between w-screen fixed ${navSelected ? `h-screen` : `h-[3.5rem]`} overflow-hidden transition-all lg:h-max`}>
